				...
				<div class="row m-t-0">
					...
					<div class="col-sm-6 col-md-4 m-b-sm-30">
						<div align="center" style="margin:auto; height:600px; width:290px">
                            ...
                            <div id="blksho"><img src="img/478/SHORT/118-blk.png" width="290" height="600" /></div>
                            <div id="bursho"><img src="img/478/SHORT/118-bur.png" width="290" height="600" /></div>
                            <div id="colsho"><img src="img/478/SHORT/118-col.png" width="290" height="600" /></div>
                            <div id="gldsho"><img src="img/478/SHORT/118-gld.png" width="290" height="600" /></div>
                            <div id="hunsho"><img src="img/478/SHORT/118-hun.png" width="290" height="600" /></div>
                            <div id="navsho"><img src="img/478/SHORT/118-nav.png" width="290" height="600" /></div>
                            <div id="redsho"><img src="img/478/SHORT/118-red.png" width="290" height="600" /></div>
                            <div id="roysho"><img src="img/478/SHORT/118-roy.png" width="290" height="600" /></div>
                            <div id="whtsho"><img src="img/478/SHORT/118-wht.png" width="290" height="600" /></div>
                           
                            <div id="burbase"><img src="img/478/JERSEY/478-bur.png" width="290" height="600" /></div> 
                            <div id="chabase"><img src="img/478/JERSEY/478-cha.png" width="290" height="600" /></div> 
                            <div id="chrbase"><img src="img/478/JERSEY/478-chr.png" width="290" height="600" /></div> 
                            <div id="colbase"><img src="img/478/JERSEY/478-col.png" width="290" height="600" /></div> 
                            <div id="gldbase"><img src="img/478/JERSEY/478-gld.png" width="290" height="600" /></div>   
                            <div id="hunbase"><img src="img/478/JERSEY/478-hun.png" width="290" height="600" /></div>
                            <div id="kelbase"><img src="img/478/JERSEY/478-kel.png" width="290" height="600" /></div>
                            <div id="lembase"><img src="img/478/JERSEY/478-lem.png" width="290" height="600" /></div>
                            <div id="limbase"><img src="img/478/JERSEY/478-lim.png" width="290" height="600" /></div>
                            <div id="navbase"><img src="img/478/JERSEY/478-nav.png" width="290" height="600" /></div>
                            <div id="orgbase"><img src="img/478/JERSEY/478-org.png" width="290" height="600" /></div>
                            <div id="pnkbase"><img src="img/478/JERSEY/478-pnk.png" width="290" height="600" /></div>
                            <div id="purbase"><img src="img/478/JERSEY/478-pur.png" width="290" height="600" /></div>
                            <div id="redbase"><img src="img/478/JERSEY/478-red.png" width="290" height="600" /></div> 
                            <div id="roybase"><img src="img/478/JERSEY/478-roy.png" width="290" height="600" /></div> 
                            <div id="silbase"><img src="img/478/JERSEY/478-sil.png" width="290" height="600" /></div>
                            <div id="turbase"><img src="img/478/JERSEY/478-tur.png" width="290" height="600" /></div>
                            <div id="whtbase"><img src="img/478/JERSEY/478-wht.png" width="290" height="600" /></div>
					...
					<div class="col-sm-6 col-md-4 m-b-sm-30">
                        ...
                        <table border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr>
                            	<td colspan="6"><div align="center">Price starting at <font size="5px" color="ed1b24">$25.45</font></div></td>
                            </tr>
                            <tr>
                                <td colspan="6"><div align="center">Jersey Color</div></td>
                            </tr>
                            <tr>
                              	<td><img src="assets/images/Uniforms/swatches/bur.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnbur.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/bur.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('burbase','','show','chabase','','hide','chrbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-BUR/WHT'" /></td>
                              	<td><img src="assets/images/Uniforms/swatches/cha.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwncha.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/cha.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','show','chrbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-CHA/WHT'" /></td>
                              	<td><em><img src="assets/images/Uniforms/swatches/chr.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnchr.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/chr.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','show','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-CHR/WHT'" /></em></td>
                              	<td><img src="assets/images/Uniforms/swatches/col.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwncol.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/col.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','hide','colbase','','show','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor');document.getElementById('ballcolor').value = '478-COL/WHT'" /></td>
                              	<td><img src="assets/images/Uniforms/swatches/gld.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwngld.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/gld.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','hide','colbase','','hide','gldbase','','show','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-GLD/WHT'" /></td>
                              	<td><img src="assets/images/Uniforms/swatches/hun.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnhun.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/hun.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','show','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-HUN/WHT'" /></td>
                          	</tr>
                            <tr>
                              	<td><em><img src="assets/images/Uniforms/swatches/kel.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnkel.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/kel.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','show','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-KEL/WHT'" /></em></td>
                              	<td><em><img src="assets/images/Uniforms/swatches/lem.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnlem.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/lem.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','show','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-LEM/WHT'" /></em></td>
                              	<td><em><img src="assets/images/Uniforms/swatches/lim.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnlim.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/lim.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','show','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-LIM/WHT'" /></em></td>
                              	<td><em><img src="assets/images/Uniforms/swatches/nav.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnnav.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/nav.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','navbase','','show','orgbase','','hide','redbase','','hide','roybase','','hide','wnabase','','hide','wrebase','','hide','wrobase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-NAV/WHT'" /></em></td>
                              	<td><em><img src="assets/images/Uniforms/swatches/org.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnorg.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/org.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','navbase','','hide','orgbase','','show','redbase','','hide','roybase','','hide','wnabase','','hide','wrebase','','hide','wrobase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-ORG/WHT'" /></em></td>
                              	<td><em><img src="assets/images/Uniforms/swatches/pnk.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnpnk.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/pnk.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','show','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-PNK/WHT'" /></em></td>
                          	</tr>
                            <tr>
                                <td><em><img src="assets/images/Uniforms/swatches/pur.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnpur.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/pur.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','show','redbase','','hide','roybase','','hide','silbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-PUR/WHT'" /></em></td>
                                <td><em><img src="assets/images/Uniforms/swatches/red.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnred.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/red.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','show','roybase','','hide','silbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-RED/WHT'" /></em></td>
                                <td><em><img src="assets/images/Uniforms/swatches/roy.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnroy.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/roy.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','show','silbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-ROY/WHT'" /></em></td>
                                <td><em><img src="assets/images/Uniforms/swatches/sil.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnsil.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/sil.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','show','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '478-SIL/WHT'" /></em></td>
                                <td><em><img src="assets/images/Uniforms/swatches/tur.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwntur.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/tur.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','turbase','','show','whtbase','','hide');document.getElementById('ballcolor').value = '478-TUR/WHT'" /></em></td>
                                <td><em><img src="assets/images/Uniforms/swatches/wht.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnwht.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/wht.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('burbase','','hide','chabase','','hide','chrbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','turbase','','hide','whtbase','','show');document.getElementById('ballcolor').value = '478-WHT/WHT'" /></em></td>
                            </tr>
                            ...
                            <tr>
                              	<td><span title="BLK/WHT"><img src="assets/images/Uniforms/swatches/blk.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnblk.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/blk.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','show','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '118-BLK'" /></span></td>
                              	<td><span title="BUR/WHT"><img src="assets/images/Uniforms/swatches/bur.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnbur.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/bur.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','show','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '118-BUR'" /></span></td>
                              	<td><span title="COL/WHT"><img src="assets/images/Uniforms/swatches/col.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwncol.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/col.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','show','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '118-COL'" /></span></td>
                              	<td><span title="GLD/WHT"><img src="assets/images/Uniforms/swatches/gld.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwngld.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/gld.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','show','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '118-GLD'" /></span></td>
                              	<td><span title="HUN/WHT"><img src="assets/images/Uniforms/swatches/hun.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnhun.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/hun.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','show','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '118-HUN'" /></span></td>
                              	<td><img src="assets/images/Uniforms/swatches/nav.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnnav.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/nav.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','show','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '118-NAV'" /></td>
                            </tr>
                            <tr>
                                <td><img src="assets/images/Uniforms/swatches/red.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnred.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/red.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','show','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '118-RED'" /></td>
                                <td></em><img src="assets/images/Uniforms/swatches/roy.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnroy.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/roy.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','show','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '118-ROY'" /></td>
                                <td><img src="assets/images/Uniforms/swatches/wht.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnwht.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/wht.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','show');document.getElementById('ink1').value = '118-WHT'" /></td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
...
<div style="width:270px"><h2 align="center" style="margin-top:-10px"><input name="Design" id="spain500" value="SPAIN 500" type="hidden" /></h2>
</div>
        ...
        <div id="con2" class="modal fade" tabindex="-1">
            <div class="modal-dialog" style="background-color:#FFF">
                ...
                <div class="modal-body">
                        <ul>
                          <li>Spain Kit Includes: 1 Jersey, 1 Madrid 115A Shorts, 1 Elite No.828 Socks, 1 2-Color 3.5” Standard Logo & 2-Color 8” Standard Back Number.</li>
                            
                          <li>Modern technology combines with classic styling in the high-end soccer jersey.  Built to last, the Spain No.500 jersey will get you ready to smash the competition.</li>
