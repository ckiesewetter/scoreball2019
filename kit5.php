				...
				<div class="row m-t-0">
					...
					<div class="col-sm-6 col-md-4 m-b-sm-30">
						<div align="center" style="margin:auto; height:600px; width:290px">
                            ...
                            <div id="blksho"><img src="img/526/SHORT/126-blk.png" width="290" height="600" /></div>
                            <div id="bursho"><img src="img/526/SHORT/126-bur.png" width="290" height="600" /></div>
                            <div id="colsho"><img src="img/526/SHORT/126-col.png" width="290" height="600" /></div>
                            <div id="hunsho"><img src="img/526/SHORT/126-hun.png" width="290" height="600" /></div>
                            <div id="navsho"><img src="img/526/SHORT/126-nav.png" width="290" height="600" /></div>
                            <div id="orgsho"><img src="img/526/SHORT/126-org.png" width="290" height="600" /></div>
                            <div id="redsho"><img src="img/526/SHORT/126-red.png" width="290" height="600" /></div>
                            <div id="roysho"><img src="img/526/SHORT/126-roy.png" width="290" height="600" /></div>
                            <div id="wnasho"><img src="img/526/SHORT/126-whtnav.png" width="290" height="400" /></div>
                            <div id="wresho"><img src="img/526/SHORT/126-whtred.png" width="290" height="400" /></div>
                            <div id="wrosho"><img src="img/526/SHORT/126-whtroy.png" width="290" height="400" /></div>
                            <div id="whtsho"><img src="img/526/SHORT/126-whtwht.png" width="290" height="600" /></div>
                            
                            <div id="blkbase"><img src="img/526/JERSEY/526-blk.png" width="290" height="600" /></div> 
                            <div id="burbase"><img src="img/526/JERSEY/526-bur.png" width="290" height="600" /></div> 
                            <div id="colbase"><img src="img/526/JERSEY/526-col.png" width="290" height="600" /></div> 
                            <div id="hunbase"><img src="img/526/JERSEY/526-hun.png" width="290" height="600" /></div>
                            <div id="navbase"><img src="img/526/JERSEY/526-nav.png" width="290" height="600" /></div>
                            <div id="orgbase"><img src="img/526/JERSEY/526-org.png" width="290" height="600" /></div>
                            <div id="redbase"><img src="img/526/JERSEY/526-red.png" width="290" height="600" /></div> 
                            <div id="roybase"><img src="img/526/JERSEY/526-roy.png" width="290" height="600" /></div> 
                            <div id="wnabase"><img src="img/526/JERSEY/526-whtnav.png" width="290" height="600" /></div> 
                            <div id="wrebase"><img src="img/526/JERSEY/526-whtred.png" width="290" height="600" /></div>
                            <div id="wrobase"><img src="img/526/JERSEY/526-whtroy.png" width="290" height="600" /></div>
                            <div id="whtbase"><img src="img/526/JERSEY/526-whtwht.png" width="290" height="600" /></div>
					...
					<div class="col-sm-6 col-md-4 m-b-sm-30">
                        ...
                        <table border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr>
                            	<td><span title="BLK"><img src="assets/images/Uniforms/swatches/blk.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnblk.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/blk.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','show','bursho','','hide','colsho','','hide','orgsho','','hide','hunsho','','hide','navsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '126-BLK'" /></span></td>
                                <td><span title="BUR"><img src="assets/images/Uniforms/swatches/bur.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnbur.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/bur.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','show','colsho','','hide','orgsho','','hide','hunsho','','hide','navsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '126-BUR'" /></span></td>
                                <td><span title="COL"><img src="assets/images/Uniforms/swatches/col.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwncol.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/col.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','show','orgsho','','hide','hunsho','','hide','navsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '126-COL'" /></span></td>
                                <td><img src="assets/images/Uniforms/swatches/hun.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnhun.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/hun.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','orgsho','','hide','hunsho','','show','navsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '126-HUN'" /></td>
                                <td><img src="assets/images/Uniforms/swatches/nav.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnnav.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/nav.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','orgsho','','hide','hunsho','','hide','navsho','','show','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '126-NAV'" /></td>
                                <td><img src="assets/images/Uniforms/swatches/org.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnorg.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/org.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','orgsho','','show','hunsho','','hide','navsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '126-ORG'" /></td>
                         	</tr>
                            <tr>
                            	<td><span title="RED"><img src="assets/images/Uniforms/swatches/red.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnred.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/red.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','orgsho','','hide','hunsho','','hide','navsho','','hide','redsho','','show','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '126-RED'" /></span></td>
                                <td></em><span title="ROY"><img src="assets/images/Uniforms/swatches/roy.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnroy.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/roy.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','orgsho','','hide','hunsho','','hide','navsho','','hide','redsho','','hide','roysho','','show','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '126-ROY'" /></span></td>
                                <td><em><img src="assets/images/Uniforms/swatches/socks/828-WHTNAV.png" onMouseOver="this.src='assets/images/Uniforms/swatches/socks/dwn_828-WHTNAV.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/socks/828-WHTNAV.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','orgsho','','hide','hunsho','','hide','navsho','','hide','redsho','','hide','roysho','','hide','wnasho','','show','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ballcolor').value = '126-WHT/NAV'" /></em></td>
                                <td><em><img src="assets/images/Uniforms/swatches/socks/828-WHTRED.png" onMouseOver="this.src='assets/images/Uniforms/swatches/socks/dwn_828-WHTRED.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/socks/828-WHTRED.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','orgsho','','hide','hunsho','','hide','navsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','show','wrosho','','hide','whtsho','','hide');document.getElementById('ballcolor').value = '126-WHT/RED'" /></em></td>
                                <td><em><img src="assets/images/Uniforms/swatches/socks/828-WHTROY.png" onMouseOver="this.src='assets/images/Uniforms/swatches/socks/dwn_828-WHTROY.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/socks/828-WHTROY.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','orgsho','','hide','hunsho','','hide','navsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','show','whtsho','','hide');document.getElementById('ballcolor').value = '126-WHT/ROY'" /></em></td>
                                <td><img src="assets/images/Uniforms/swatches/socks/828-WHTWHT.png" onMouseOver="this.src='assets/images/Uniforms/swatches/socks/dwn_828-WHTWHT.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/socks/828-WHTWHT.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','orgsho','','hide','hunsho','','hide','navsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','show');document.getElementById('ink1').value = '126-WHT/WHT'" /></td>
                          	</tr>
                            <tr>
                              	<td>&nbsp;</td>
                              	<td>&nbsp;</td>
...
<div style="width:270px"><h2 align="center" style="margin-top:-10px"><input name="Design" id="italy550" value="ITALY 550" type="hidden" /></h2>
</div>
        ...
        <div id="con2" class="modal fade" tabindex="-1">
            <div class="modal-dialog" style="background-color:#FFF">
                ...
                <div class="modal-body">
                        <ul>
                          <li>USA Women's Kit Includes: 1 Jersey, 1 Houston Women's Short No.126A Short, 1 Elite No.828 Socks, 1 2-Color 3.5" Standard Logo & 2-Color 8" Standard Back Number</li>
                            
                          <li>E°K Fit 120™ body, Clean V-neck collar, Sublimated gradient chevron design, Breathable E°K Fit Mesh ™ side panels, Tapered athletic fit for women, Raglan sleeves </li>
