...
<body style="margin-top:30px">
	...
	<div class="wrapper">
        ...
        <div class="row">
        		...
        		<center style="padding:20px" ><h1>SPAIN 500</h1>
				...
				<div class="row m-t-0">
					...
					<div class="col-sm-6 col-md-4 m-b-sm-30">
						<div align="center" style="margin:auto; height:600px; width:290px">
                            ...
                            <div id="blksho"><img src="img/500/short/115-blk.png" width="290" height="600" /></div>
                            <div id="bursho"><img src="img/500/short/115-bur.png" width="290" height="600" /></div>
                            <div id="colsho"><img src="img/500/short/115-col.png" width="290" height="600" /></div>
                            <div id="gldsho"><img src="img/500/short/115-gld.png" width="290" height="600" /></div>
                            <div id="hunsho"><img src="img/500/short/115-hun.png" width="290" height="600" /></div>
                            <div id="navsho"><img src="img/500/short/115-nav.png" width="290" height="600" /></div>
                            <div id="orgsho"><img src="img/500/short/115-org.png" width="290" height="600" /></div>
                            <div id="redsho"><img src="img/500/short/115-red.png" width="290" height="600" /></div>
                            <div id="roysho"><img src="img/500/short/115-roy.png" width="290" height="600" /></div>
                            <div id="wnasho"><img src="img/500/short/115-whtnav.png" width="290" height="600" /></div>
                            <div id="wresho"><img src="img/500/short/115-whtred.png" width="290" height="600" /></div>
                            <div id="wrosho"><img src="img/500/short/115-whtroy.png" width="290" height="600" /></div>
                            <div id="whtsho"><img src="img/500/short/115-whtwht.png" width="290" height="600" /></div>
                            
                            <div id="blkbase"><img src="img/500/jersey/500-blk.png" width="290" height="600" /></div> 
                            <div id="burbase"><img src="img/500/jersey/500-bur.png" width="290" height="600" /></div> 
                            <div id="colbase"><img src="img/500/jersey/500-col.png" width="290" height="600" /></div> 
                            <div id="gldbase"><img src="img/500/jersey/500-gld.png" width="290" height="600" /></div>   
                            <div id="hunbase"><img src="img/500/jersey/500-hun.png" width="290" height="600" /></div>
                            <div id="navbase"><img src="img/500/jersey/500-nav.png" width="290" height="600" /></div>
                            <div id="orgbase"><img src="img/500/jersey/500-org.png" width="290" height="600" /></div>
                            <div id="redbase"><img src="img/500/jersey/500-red.png" width="290" height="600" /></div> 
                            <div id="roybase"><img src="img/500/jersey/500-roy.png" width="290" height="600" /></div> 
                            <div id="wnabase"><img src="img/500/jersey/500-whtnav.png" width="290" height="600" /></div> 
                            <div id="wrebase"><img src="img/500/jersey/500-whtred.png" width="290" height="600" /></div>
                            <div id="wrobase"><img src="img/500/jersey/500-whtroy.png" width="290" height="600" /></div>
                            <div id="whtbase"><img src="img/500/jersey/500-whtwht.png" width="290" height="600" /></div>
					...
					<div class="col-sm-6 col-md-4 m-b-sm-30">
                        ...
                        <table border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr>
                              	<td><span title="BLK/WHT"><img src="assets/images/Uniforms/swatches/blk.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnblk.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/blk.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','show','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '115A-BLK/WHT'" /></span></td>
                              	<td><span title="BUR/WHT"><img src="assets/images/Uniforms/swatches/bur.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnbur.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/bur.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','show','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '115A-BUR/WHT'" /></span></td>
                              	<td><span title="COL/WHT"><img src="assets/images/Uniforms/swatches/col.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwncol.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/col.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','show','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '115A-COL/WHT'" /></span></td>
                              	<td><span title="GLD/WHT"><img src="assets/images/Uniforms/swatches/gld.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwngld.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/gld.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','show','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '115A-GLD/WHT'" /></span></td>
                              	<td><span title="HUN/WHT"><img src="assets/images/Uniforms/swatches/hun.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnhun.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/hun.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','show','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '115A-HUN/WHT'" /></span></td>
                              	<td><img src="assets/images/Uniforms/swatches/nav.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnnav.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/nav.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','show','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '115A-NAV/WHT'" /></td>
                            </tr>
                            <tr>
                                <td><img src="assets/images/Uniforms/swatches/org.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnorg.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/org.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','show','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '115A-ORG/WHT'" /></td>
                                <td></em><img src="assets/images/Uniforms/swatches/red.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnred.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/red.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','show','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '115A-RED/WHT'" /></td>
                                <td><img src="assets/images/Uniforms/swatches/roy.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnroy.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/roy.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','show','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '115A-ROY/WHT'" /></td>
                                <td><img src="assets/images/Uniforms/swatches/socks/828-WHTNAV.png" onMouseOver="this.src='assets/images/Uniforms/swatches/socks/dwn_828-WHTNAV.png'" onMouseOut="assets/images/Uniforms/swatches/socks/828-WHTNAV.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','show','wresho','','hide','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '115A-WHT/NAV'" /></td>
                                <td><img src="assets/images/Uniforms/swatches/socks/828-WHTRED.png" onMouseOver="this.src='assets/images/Uniforms/swatches/socks/dwn_828-WHTRED.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/socks/828-WHTRED.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','show','wrosho','','hide','whtsho','','hide');document.getElementById('ink1').value = '115A-WHT/RED'" /></td>
                                <td><img src="assets/images/Uniforms/swatches/socks/828-WHTROY.png" onMouseOver="this.src='assets/images/Uniforms/swatches/socks/dwn_828-WHTROY.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/socks/828-WHTROY.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','show','whtsho','','hide');document.getElementById('ink1').value = '115A-WHT/ROY'" /></td>
                            </tr>
                            <tr>
                              	<td><em><img src="assets/images/Uniforms/swatches/wht.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnwht.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/wht.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','navsho','','hide','orgsho','','hide','redsho','','hide','roysho','','hide','wnasho','','hide','wresho','','hide','wrosho','','hide','whtsho','','show');document.getElementById('ink1').value = '115A-WHT/WHT'" /></em></td>
                              	<td>&nbsp;</td>
                              	<td>&nbsp;</td>
                              	<td>&nbsp;</td>
                              	<td>&nbsp;</td>
