...
<head>
	...
	<title>Custom Soccer Ball 2019</title>
...
<body style="margin-top:30px">
	...
	<div class="wrapper">
				...
				<div class="row m-t-0">
                    ...
                    <div align="center"><span style="margin-top:-10px"><h2 align="center" style="margin-top:-10px"><font color="#FFFFFF">Custom Design 1</font></h2></span></div>
						...
						<div align="center" style="margin:auto; height:290px; width:290px">
                            ...
                            <div id="limbase2"><img src="assets/images/Balls/DESIGN1/DES1-PRIMARY-LIM.png" width="290" height="290" /></div>
                            ...
                            <div id="kelbase3"><img src="assets/images/Balls/DESIGN1/DES1-SECONDARY-KEL.png" width="290" height="290" /></div>
							              <div id="limbase3"><img src="assets/images/Balls/DESIGN1/DES1-SECONDARY-LIM.png" width="290" height="290" /></div>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><img src="assets/images/Uniforms/swatches/lem.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnlem.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/lem.png'" alt="s" width="20" height="20" onClick="MM_showHideLayers('blkbase1','','hide','burbase1','','hide','chabase1','','hide','chrbase1','','hide','colbase1','','hide','gldbase1','','hide','hunbase1','','hide','kelbase1','','hide','lembase1','','show','limbase2','','hide','navbase1','','hide','orgbase1','','hide','pnkbase1','','hide','purbase1','','hide','redbase1','','hide','roybase1','','hide','silbase1','','hide','turbase1','','hide','whtbase1','','hide');document.getElementById('ballcolor1').value = 'LEM'" /></td>
        <td><img src="assets/images/Uniforms/swatches/sil.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnsil.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/sil.png'" alt="s" width="20" height="20" onClick="MM_showHideLayers('blkbase1','','hide','burbase1','','hide','chabase1','','hide','chrbase1','','hide','colbase1','','hide','gldbase1','','hide','hunbase1','','hide','kelbase1','','hide','lembase1','','hide','limbase2','','hide','navbase1','','hide','orgbase1','','hide','pnkbase1','','hide','purbase1','','hide','redbase1','','hide','roybase1','','hide','silbase1','','show','turbase1','','hide','whtbase1','','hide');document.getElementById('ballcolor1').value = 'SIL'" /></td>
        <td><img src="assets/images/Uniforms/swatches/wht.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnwht.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/wht.png'" alt="s" width="20" height="20" onClick="MM_showHideLayers('blkbase1','','hide','burbase1','','hide','chabase1','','hide','chrbase1','','hide','colbase1','','hide','gldbase1','','hide','hunbase1','','hide','kelbase1','','hide','lembase1','','hide','limbase2','','hide','navbase1','','hide','orgbase1','','hide','pnkbase1','','hide','purbase1','','hide','redbase1','','hide','roybase1','','hide','silbase1','','hide','turbase1','','hide','whtbase1','','show');document.getElementById('ballcolor1').value = 'WHT'" /></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td><img src="assets/images/Uniforms/swatches/lim.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnlim.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/lim.png'" alt="s" width="20" height="20"onClick="MM_showHideLayers('blkbase2','','hide','burbase2','','hide','chabase2','','hide','chrbase2','','hide','colbase2','','hide','gldbase2','','hide','hunbase2','','hide','kelbase2','','hide','limbase2','','show','navbase2','','hide','orgbase2','','hide','pnkbase2','','hide','purbase2','','hide','redbase2','','hide','roybase2','','hide','silbase2','','hide','turbase2','','hide','whtbase2','','hide','yelbase2','','hide');document.getElementById('ballcolor2').value = 'LIM'" /></td>
