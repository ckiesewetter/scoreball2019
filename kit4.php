...
<body style="margin-top:30px">
	...
	<div class="wrapper">
        ...
        <div class="row">
        		...
        		<center style="padding:20px" ><h1>BRAZIL 447</h1>
				...
				<div class="row m-t-0">
					...
					<div class="col-sm-6 col-md-4 m-b-sm-30">
						<div align="center" style="margin:auto; height:600px; width:290px">
                            ...
                            <div id="blksho"><img src="img/447/SHORT/195-blk.png" width="290" height="600" /></div>
                            <div id="bursho"><img src="img/447/SHORT/195-bur.png" width="290" height="600" /></div>
                            <div id="chasho"><img src="img/447/SHORT/195-cha.png" width="290" height="600" /></div>
                            <div id="chrsho"><img src="img/447/SHORT/195-chr.png" width="290" height="600" /></div>
                            <div id="colsho"><img src="img/447/SHORT/195-col.png" width="290" height="600" /></div>
                            <div id="gldsho"><img src="img/447/SHORT/195-gld.png" width="290" height="600" /></div>
                            <div id="hunsho"><img src="img/447/SHORT/195-hun.png" width="290" height="600" /></div>
                            <div id="kelsho"><img src="img/447/SHORT/195-kel.png" width="290" height="600" /></div>
                            <div id="limsho"><img src="img/447/SHORT/195-lim.png" width="290" height="600" /></div>
                            <div id="navsho"><img src="img/447/SHORT/195-nav.png" width="290" height="600" /></div>
                            <div id="orgsho"><img src="img/447/SHORT/195-org.png" width="290" height="600" /></div>
                            <div id="pnksho"><img src="img/447/SHORT/195-pnk.png" width="290" height="600" /></div>
                            <div id="pursho"><img src="img/447/SHORT/195-pur.png" width="290" height="600" /></div>
                            <div id="redsho"><img src="img/447/SHORT/195-red.png" width="290" height="600" /></div>
                            <div id="roysho"><img src="img/447/SHORT/195-roy.png" width="290" height="600" /></div>
                            <div id="silsho"><img src="img/447/SHORT/195-sil.png" width="290" height="600" /></div>
                            <div id="tursho"><img src="img/447/SHORT/195-tur.png" width="290" height="600" /></div>
                            <div id="whtsho"><img src="img/447/SHORT/195-wht.png" width="290" height="600" /></div>                            
                            
                            <div id="blkbase"><img src="img/447/JERSEY/447-blk.png" width="290" height="600" /></div>
                            <div id="burbase"><img src="img/447/JERSEY/447-bur.png" width="290" height="600" /></div>
                            <div id="colbase"><img src="img/447/JERSEY/447-col.png" width="290" height="600" /></div> 
                            <div id="gldbase"><img src="img/447/JERSEY/447-gld.png" width="290" height="600" /></div>   
                            <div id="hunbase"><img src="img/447/JERSEY/447-hun.png" width="290" height="600" /></div> 
                            <div id="kelbase"><img src="img/447/JERSEY/447-kel.png" width="290" height="600" /></div> 
                            <div id="lembase"><img src="img/447/JERSEY/447-lem.png" width="290" height="600" /></div>
                            <div id="limbase"><img src="img/447/JERSEY/447-lim.png" width="290" height="600" /></div>
                            <div id="navbase"><img src="img/447/JERSEY/447-nav.png" width="290" height="600" /></div>
                            <div id="orgbase"><img src="img/447/JERSEY/447-org.png" width="290" height="600" /></div>   
                            <div id="purbase"><img src="img/447/JERSEY/447-pur.png" width="290" height="600" /></div>    
                            <div id="redbase"><img src="img/447/JERSEY/447-red.png" width="290" height="600" /></div> 
                            <div id="roybase"><img src="img/447/JERSEY/447-roy.png" width="290" height="600" /></div> 
                            <div id="silbase"><img src="img/447/JERSEY/447-sil.png" width="290" height="600" /></div> 
                            <div id="tanbase"><img src="img/447/JERSEY/447-tng.png" width="290" height="600" /></div> 
                            <div id="turbase"><img src="img/447/JERSEY/447-tur.png" width="290" height="600" /></div>
                            <div id="whtbase"><img src="img/447/JERSEY/447-wht.png" width="290" height="600" /></div>
      ...
      <tr>
                                    			  <td colspan="6"><div align="center">Price starting at <font size="5px" color="ed1b24">$23.95</font></div></td>
   			    </tr>
                                    			<tr>
                                    			  <td colspan="6"><div align="center">Jersey Color</div></td>
                                   			  </tr>
                                    			<tr>
                                    			  <td><em><span title="BLK/BLK/WHT"><img src="assets/images/Uniforms/swatches/blk.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnblk.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/blk.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blkbase','','show','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-BLK/BLK/WHT'" /></span></em></td>
                                    			  <td><span title="BUR/BUR/WHT"><img src="assets/images/Uniforms/swatches/bur.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnbur.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/bur.png'" width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','show','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-BUR/BUR/WHT'" /></span></td>
                                    			  <td><span title="COL/NAV/WHT"><img src="assets/images/Uniforms/swatches/col.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwncol.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/col.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','show','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-COL/NAV/WHT'" /></span></td>
                                                  <td><img src="assets/images/Uniforms/swatches/gld.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwngld.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/gld.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','show','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-GLD/ROY/WHT'" /></td>
                                    			  <td><img src="assets/images/Uniforms/swatches/hun.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnhun.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/hun.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','show','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-HUN/HUN/WHT'" /></td>
                                    			  <td><img src="assets/images/Uniforms/swatches/kel.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnkel.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/kel.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','show','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-KEL/ROY/WHT'" /></td>
                                   			  </tr>
                                    			<tr>
                                    			  <td><img src="assets/images/Uniforms/swatches/lem.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnlem.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/lem.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','show','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-LEM/WHT/WHT'" /></td>
                                    			  <td><img src="assets/images/Uniforms/swatches/lim.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnlim.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/lim.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','show','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-LIM/NAV/WHT'" /></td>
                                    			  <td><em><img src="assets/images/Uniforms/swatches/nav.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnnav.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/nav.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','show','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-NAV/NAV/WHT'" /></em></td>
                                    			  <td><em><img src="assets/images/Uniforms/swatches/org.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnorg.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/org.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','show','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-ORG/NAV/WHT'" /></em></td>
                                    			  <td><em><img src="assets/images/Uniforms/swatches/pur.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnpur.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/pur.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','show','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-PUR/BLK/WHT'" /></em></td>
                                   			  
                                      				<td><em><img src="assets/images/Uniforms/swatches/red.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnred.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/red.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','show','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-RED/RED/WHT'" /></em></td>
           				  </tr>
                                    			<tr>
                                                <td><em><img src="assets/images/Uniforms/swatches/roy.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnroy.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/roy.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','show','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-ROY/ROY/WHT'" /></em></td>
                                      				<td><em><img src="assets/images/Uniforms/swatches/sil.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnsil.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/sil.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','show','tanbase','','hide','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-SIL/NAV/WHT'" /></em></td>
                                      				<td><em><img src="assets/images/Uniforms/swatches/tng.png" onMouseOver="this.src='assets/images/Uniforms/swatches/tng.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/tng.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','show','turbase','','hide','whtbase','','hide');document.getElementById('ballcolor').value = '447-TNG/BLK/WHT'" /></em></td>
                                      				<td><em><em><img src="assets/images/Uniforms/swatches/tur.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwntur.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/tur.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','show','whtbase','','hide');document.getElementById('ballcolor').value = '447-TUR/BLK/WHT'" /></em></em></td>
                                      				<td><em><img src="assets/images/Uniforms/swatches/wht.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnwht.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/wht.png'" alt="." width="40" height="40" onClick="MM_showHideLayers('blkbase','','hide','burbase','','hide','colbase','','hide','gldbase','','hide','hunbase','','hide','kelbase','','hide','lembase','','hide','limbase','','hide','navbase','','hide','orgbase','','hide','pnkbase','','hide','purbase','','hide','redbase','','hide','roybase','','hide','silbase','','hide','tanbase','','hide','turbase','','hide','whtbase','','show');document.getElementById('ballcolor').value = '447-WHT/WHT/WHT'" /></em></td>
                                   				</tr>
                                                ...
                                                <tr>
                                                  <td><span title="BLK"><img src="assets/images/Uniforms/swatches/blk.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnblk.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/blk.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','show','bursho','','hide','chasho','','hide','chrsho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','kelsho','','hide','limsho','','hide','navsho','','hide','orgsho','','hide','pnksho','','hide','pursho','','hide','redsho','','hide','roysho','','hide','silsho','','hide','tursho','','hide','whtsho','','hide');document.getElementById('ink1').value = '195-BLK/WHT'" /></span></td>
                                                  <td><span title="BUR"><img src="assets/images/Uniforms/swatches/bur.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnbur.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/bur.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','show','chasho','','hide','chrsho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','kelsho','','hide','limsho','','hide','navsho','','hide','orgsho','','hide','pnksho','','hide','pursho','','hide','redsho','','hide','roysho','','hide','silsho','','hide','tursho','','hide','whtsho','','hide');document.getElementById('ink1').value = '195-BUR/WHT'" /></span></td>
                                                  <td><img src="assets/images/Uniforms/swatches/col.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwncol.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/col.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','chasho','','hide','chrsho','','hide','colsho','','show','gldsho','','hide','hunsho','','hide','kelsho','','hide','limsho','','hide','navsho','','hide','orgsho','','hide','pnksho','','hide','pursho','','hide','redsho','','hide','roysho','','hide','silsho','','hide','tursho','','hide','whtsho','','hide');document.getElementById('ink1').value = '195-COL/WHT'" /></td>
                                                  <td><img src="assets/images/Uniforms/swatches/gld.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwngld.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/gld.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','chasho','','hide','chrsho','','hide','colsho','','hide','gldsho','','show','hunsho','','hide','kelsho','','hide','limsho','','hide','navsho','','hide','orgsho','','hide','pnksho','','hide','pursho','','hide','redsho','','hide','roysho','','hide','silsho','','hide','tursho','','hide','whtsho','','hide');document.getElementById('ink1').value = '195-GLD/WHT'" /></td>
                                                  <td><img src="assets/images/Uniforms/swatches/hun.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnhun.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/hun.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','chasho','','hide','chrsho','','hide','colsho','','hide','gldsho','','hide','hunsho','','show','kelsho','','hide','limsho','','hide','navsho','','hide','orgsho','','hide','pnksho','','hide','pursho','','hide','redsho','','hide','roysho','','hide','silsho','','hide','tursho','','hide','whtsho','','hide');document.getElementById('ink1').value = '195-HUN/WHT'" /></td>
                                                  <td><img src="assets/images/Uniforms/swatches/kel.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnkel.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/kel.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','chasho','','hide','chrsho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','kelsho','','show','limsho','','hide','navsho','','hide','orgsho','','hide','pnksho','','hide','pursho','','hide','redsho','','hide','roysho','','hide','silsho','','hide','tursho','','hide','whtsho','','hide');document.getElementById('ink1').value = '195-KEL/WHT'" /></td>
                                                </tr>
                                                <tr>
                                                  <td><img src="assets/images/Uniforms/swatches/nav.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnnav.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/nav.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','chasho','','hide','chrsho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','kelsho','','hide','limsho','','hide','navsho','','show','orgsho','','hide','pnksho','','hide','pursho','','hide','redsho','','hide','roysho','','hide','silsho','','hide','tursho','','hide','whtsho','','hide');document.getElementById('ink1').value = '195-NAV/WHT'" /></td>
                                                  <td></em><img src="assets/images/Uniforms/swatches/pur.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnpur.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/pur.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','chasho','','hide','chrsho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','kelsho','','hide','limsho','','hide','navsho','','hide','orgsho','','hide','pnksho','','hide','pursho','','show','redsho','','hide','roysho','','hide','silsho','','hide','tursho','','hide','whtsho','','hide');document.getElementById('ink1').value = '195-PUR/WHT'" /></td>
                                                  <td><img src="assets/images/Uniforms/swatches/red.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnred.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/red.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','chasho','','hide','chrsho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','kelsho','','hide','limsho','','hide','navsho','','hide','orgsho','','hide','pnksho','','hide','pursho','','hide','redsho','','show','roysho','','hide','silsho','','hide','tursho','','hide','whtsho','','hide');document.getElementById('ink1').value = '195-RED/WHT'" /></td>
                                                  <td><img src="assets/images/Uniforms/swatches/roy.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnroy.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/roy.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','chasho','','hide','chrsho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','kelsho','','hide','limsho','','hide','navsho','','hide','orgsho','','hide','pnksho','','hide','pursho','','hide','redsho','','hide','roysho','','show','silsho','','hide','tursho','','hide','whtsho','','hide');document.getElementById('ink1').value = '195-ROY/WHT'" /></td>
                                                  <td></em><img src="assets/images/Uniforms/swatches/sil.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnsil.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/sil.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','chasho','','hide','chrsho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','kelsho','','hide','limsho','','hide','navsho','','hide','orgsho','','hide','pnksho','','hide','pursho','','hide','redsho','','hide','roysho','','hide','silsho','','show','tursho','','hide','whtsho','','hide');document.getElementById('ink1').value = '195-SIL/WHT'" /></td>
                                                  <td><img src="assets/images/Uniforms/swatches/wht.png" onMouseOver="this.src='assets/images/Uniforms/swatches/dwnwht.png'" onMouseOut="this.src='assets/images/Uniforms/swatches/wht.png'" alt="s" width="40" height="40" onClick="MM_showHideLayers('blksho','','hide','bursho','','hide','chasho','','hide','chrsho','','hide','colsho','','hide','gldsho','','hide','hunsho','','hide','kelsho','','hide','limsho','','hide','navsho','','hide','orgsho','','hide','pnksho','','hide','pursho','','hide','redsho','','hide','roysho','','hide','silsho','','hide','tursho','','hide','whtsho','','show');document.getElementById('ink1').value = '195-WHT/WHT'" /></td>
                                                </tr>
                                                <tr>
...
<div style="width:270px"><h2 align="left" style="margin-top:-10px"><input name="Design" id="brazil447" value="BRAZIL 447" type="hidden" /></h2>
</div>
...
// ]]>
				...
				<div class="row">
					...
					<div id="works-grid" class="works-grid works-hover-w">
						...
						<div class="work-item design">
							<a href="http://scoresports.com/bermuda-no-319.html">
								<img src="assets/images/portfolio/storeitems/8/si_0001_goalie_ls.jpg" alt="">
								<div class="work-caption font-alt">
									<h3 class="work-title">Bermuda No.319</h3>
						...
						<div class="work-item design">
							<a href="http://scoresports.com/striker-no-9740.html">
								<img src="assets/images/portfolio/storeitems/8/si_0002_9740.jpg" alt="">
								<div class="work-caption font-alt">
						...
						<!-- PORTFOLIO ITEM -->
						<div class="work-item design">
							<a href="http://scoresports.com/pro-premier-no-9270.html">
								<img src="assets/images/portfolio/storeitems/8/si_0004_9270.jpg" alt="">
								<div class="work-caption font-alt">
									<h3 class="work-title">Pro Premier No.9270</h3>
									<div class="work-descr">
										GOALIE ACCESSORIE
									</div>
								</div>
                        ...
                        <!-- PORTFOLIO ITEM -->
						<div class="work-item design">
							<a href="http://scoresports.com/ultima-no-1800.html">
								<img src="assets/images/portfolio/storeitems/8/si_0010_1800_1.jpg" alt="">
								<div class="work-caption font-alt">
 	...
 	<div class="modal-dialog" style="background-color:#FFF">
        ...
        <div class="modal-body">
            	<ul>
                  <li>Brazil Kit Includes: 1, Jersey, 1 London No.195A, 1 Elite No.828 Socks, 1 2-Color 3.5” Standard Logo & 2-Color 8” Standard Back Number.</li>
                    
                  <li>Championing style and performance, this classic jersey was designed with winning in mind. The Brazil provides a clean, polished, yet modern look with its contrast piping finish and metallic heat transfer accent.</li>
